...
public class SaveLoad139 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "139"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "139"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "139"))
        {
