...
public class SaveLoad178 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "178"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "178"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "178"))
        {
