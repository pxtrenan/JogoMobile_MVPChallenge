...
public class SaveLoad163 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "163"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "163"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "163"))
        {
