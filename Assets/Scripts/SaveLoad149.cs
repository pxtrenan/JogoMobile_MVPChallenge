...
public class SaveLoad149 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "149"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "149"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "149"))
        {
