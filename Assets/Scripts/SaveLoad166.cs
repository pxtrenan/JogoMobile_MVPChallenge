...
public class SaveLoad166 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "166"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "166"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "166"))
        {
