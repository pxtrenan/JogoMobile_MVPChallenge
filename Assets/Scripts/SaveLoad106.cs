...
public class SaveLoad106 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "106"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "106"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "106"))
        {
