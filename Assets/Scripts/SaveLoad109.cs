...
public class SaveLoad109 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "109"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "109"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "109"))
        {
