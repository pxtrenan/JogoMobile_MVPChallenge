...
public class SaveLoad151 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "151"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "151"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "151"))
        {
