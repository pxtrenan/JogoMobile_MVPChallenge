...
public class SaveLoad129 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "129"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "129"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "129"))
        {
