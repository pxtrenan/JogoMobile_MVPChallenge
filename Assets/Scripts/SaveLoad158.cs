...
public class SaveLoad158 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "158"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "158"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "158"))
        {
