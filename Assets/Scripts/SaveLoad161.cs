...
public class SaveLoad161 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "161"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "161"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "161"))
        {
