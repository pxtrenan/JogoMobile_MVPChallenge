...
public class SaveLoad145 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "145"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "145"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "145"))
        {
