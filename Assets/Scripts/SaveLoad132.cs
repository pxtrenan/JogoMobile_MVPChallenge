...
public class SaveLoad132 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "132"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "132"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "132"))
        {
