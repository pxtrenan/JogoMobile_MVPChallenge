...
public class SaveLoad102 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "102"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "102"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "102"))
        {
