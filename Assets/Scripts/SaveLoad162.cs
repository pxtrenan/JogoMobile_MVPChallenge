...
public class SaveLoad162 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "162"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "162"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "162"))
        {
