...
public class SaveLoad111 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "111"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "111"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "111"))
        {
