...
public class SaveLoad169 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "169"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "169"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "169"))
        {
