...
public class SaveLoad127 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "127"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "127"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "127"))
        {
