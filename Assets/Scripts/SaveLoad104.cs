...
public class SaveLoad104 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "104"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "104"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "104"))
        {
