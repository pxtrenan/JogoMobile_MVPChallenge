...
public class SaveLoad110 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "110"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "110"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "110"))
        {
