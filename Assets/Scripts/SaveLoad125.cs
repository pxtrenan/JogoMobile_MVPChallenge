...
public class SaveLoad125 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "125"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "125"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "125"))
        {
