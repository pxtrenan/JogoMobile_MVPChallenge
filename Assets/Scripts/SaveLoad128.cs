...
public class SaveLoad128 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "128"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "128"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "128"))
        {
