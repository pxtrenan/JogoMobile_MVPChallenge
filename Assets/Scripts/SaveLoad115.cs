...
public class SaveLoad115 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "115"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "115"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "115"))
        {
