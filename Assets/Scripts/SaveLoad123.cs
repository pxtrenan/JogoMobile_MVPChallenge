...
public class SaveLoad123 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "123"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "123"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "123"))
        {
