...
public class SaveLoad143 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "143"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "143"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "143"))
        {
