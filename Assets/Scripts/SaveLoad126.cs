...
public class SaveLoad126 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "126"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "126"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "126"))
        {
