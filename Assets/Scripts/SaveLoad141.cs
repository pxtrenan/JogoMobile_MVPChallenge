...
public class SaveLoad141 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "141"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "141"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "141"))
        {
