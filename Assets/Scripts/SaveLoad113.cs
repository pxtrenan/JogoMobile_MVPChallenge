...
public class SaveLoad113 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "113"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "113"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "113"))
        {
