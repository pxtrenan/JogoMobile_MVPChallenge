...
public class SaveLoad174 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "174"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "174"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "174"))
        {
