...
public class SaveLoad164 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "164"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "164"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "164"))
        {
