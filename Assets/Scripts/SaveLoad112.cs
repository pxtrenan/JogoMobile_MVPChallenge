...
public class SaveLoad112 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "112"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "112"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "112"))
        {
