...
public class SaveLoad155 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "155"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "155"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "155"))
        {
