...
public class SaveLoad175 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "175"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "175"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "175"))
        {
