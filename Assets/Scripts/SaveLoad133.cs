...
public class SaveLoad133 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "133"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "133"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "133"))
        {
