...
public class SaveLoad160 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "160"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "160"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "160"))
        {
