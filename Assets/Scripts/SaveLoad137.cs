...
public class SaveLoad137 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "137"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "137"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "137"))
        {
