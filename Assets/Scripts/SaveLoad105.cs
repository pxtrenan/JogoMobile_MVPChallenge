...
public class SaveLoad105 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "105"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "105"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "105"))
        {
