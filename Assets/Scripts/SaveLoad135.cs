...
public class SaveLoad135 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "135"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "135"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "135"))
        {
