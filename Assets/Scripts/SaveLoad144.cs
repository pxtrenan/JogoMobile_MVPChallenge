...
public class SaveLoad144 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "144"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "144"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "144"))
        {
