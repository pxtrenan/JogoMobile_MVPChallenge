...
public class SaveLoad131 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "131"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "131"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "131"))
        {
