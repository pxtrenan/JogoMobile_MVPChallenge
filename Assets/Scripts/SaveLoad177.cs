...
public class SaveLoad177 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "177"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "177"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "177"))
        {
