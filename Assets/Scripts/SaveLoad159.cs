...
public class SaveLoad159 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "159"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "159"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "159"))
        {
