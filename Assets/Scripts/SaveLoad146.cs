...
public class SaveLoad146 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "146"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "146"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "146"))
        {
