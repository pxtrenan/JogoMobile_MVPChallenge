...
public class SaveLoad116 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "116"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "116"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "116"))
        {
