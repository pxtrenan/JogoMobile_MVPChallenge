...
public class SaveLoad124 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "124"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "124"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "124"))
        {
