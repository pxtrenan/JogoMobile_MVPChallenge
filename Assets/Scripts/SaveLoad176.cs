...
public class SaveLoad176 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "176"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "176"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "176"))
        {
