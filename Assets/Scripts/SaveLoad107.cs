...
public class SaveLoad107 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "107"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "107"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "107"))
        {
