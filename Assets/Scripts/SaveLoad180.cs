...
public class SaveLoad180 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "180"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "180"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "180"))
        {
