...
public class SaveLoad171 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "171"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "171"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "171"))
        {
