...
public class SaveLoad156 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "156"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "156"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "156"))
        {
