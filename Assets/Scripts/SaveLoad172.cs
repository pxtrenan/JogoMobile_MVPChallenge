...
public class SaveLoad172 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "172"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "172"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "172"))
        {
