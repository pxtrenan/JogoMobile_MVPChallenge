...
public class SaveLoad167 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "167"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "167"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "167"))
        {
