...
public class SaveLoad100 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "100"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "100"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "100"))
        {
