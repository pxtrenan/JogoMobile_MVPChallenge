...
public class SaveLoad136 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "136"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "136"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "136"))
        {
