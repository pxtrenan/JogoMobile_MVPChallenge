...
public class SaveLoad114 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "114"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "114"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "114"))
        {
