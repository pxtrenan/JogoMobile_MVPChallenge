...
public class SaveLoad153 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "153"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "153"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "153"))
        {
