...
public class SaveLoad120 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "120"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "120"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "120"))
        {
