...
public class SaveLoad140 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "140"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "140"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "140"))
        {
