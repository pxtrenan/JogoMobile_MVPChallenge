...
public class SaveLoad154 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "154"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "154"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "154"))
        {
