...
public class SaveLoad170 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "170"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "170"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "170"))
        {
