...
public class SaveLoad101 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "101"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "101"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "101"))
        {
