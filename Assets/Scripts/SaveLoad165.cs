...
public class SaveLoad165 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "165"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "165"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "165"))
        {
