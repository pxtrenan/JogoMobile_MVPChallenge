...
public class SaveLoad150 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "150"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "150"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "150"))
        {
