...
public class SaveLoad148 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "148"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "148"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "148"))
        {
