...
public class SaveLoad130 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "130"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "130"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "130"))
        {
