...
public class SaveLoad173 : MonoBehaviour
{
    ...
    public void Levels()
    {
        ...
        if (PlayerPrefs.HasKey("tresestrelas" + "173"))
        {
        ...
        if (PlayerPrefs.HasKey("duasestrelas" + "173"))
        {
        ...
        if (PlayerPrefs.HasKey("umaestrela" + "173"))
        {
